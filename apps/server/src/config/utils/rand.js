...
class Rand {
    ...
    static generateFromSet(chars, length) {
    ...
    static randObject(obj) {
        const keys = Object.keys(obj); // Extract all keys from the object
    ...
    static randRegex(pattern, length) {
